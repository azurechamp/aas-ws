...
namespace Blend.SampleData.ArticlesSampleData
{
	using System; 
...
// the DISABLE_SAMPLE_DATA conditional compilation constant and disable sample data at runtime.
	...
	internal class ArticlesSampleData { }
#else

	public class ArticlesSampleData : INotifyPropertyChanged
	{
		...
		public ArticlesSampleData()
		{
			try
			{
				Uri resourceUri = new Uri("ms-appx:/SampleData/ArticlesSampleData/ArticlesSampleData.xaml", UriKind.RelativeOrAbsolute);
